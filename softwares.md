...
- [kaov][https://github.com/LMJL-Alea/kAOV] is a Python package dedicated to kernel testing on complex Designs, developed by [Polina Arsenteva][https://parsenteva.github.io]
...
- [Harissa](https://github.com/ulysseherbach/harissa) is a Python package for stochastic simulation and statistical inference of gene regulatory networks from single-cell data, developped by [Ulysse Herbach](https://herbach.perso.math.cnrs.fr). Check out the [presentation paper](https://doi.org/10.1007/978-3-031-42697-1_7)  (also available on [arXiv](https://doi.org/10.48550/arXiv.2309.05112)).
- [<img src="https://raw.githubusercontent.com/sistm/citcdf/main/man/figures/logo.svg" alt="" height="24px"> citcdf](https://github.com/sistm/citcdf) is an R package to perform conditional independence testing using empirical conditional cumulative distribution function estimations, with a focus on scRNA-seq differential testing.
